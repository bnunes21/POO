...
public class Oficina {
	...
	public static void main(String[] args) {
		...
		System.out.println("Com base na hora de uso, a Furadeira tem " + furadeira1.calcDesgaste(furadeira1.gethora_uso())+"% de horas de uso restantes");
		...
		System.out.println();
		System.out.println("Com base na hora de uso, a lixadeira tem " + lixadeira.calcDesgaste(lixadeira.gethora_uso())+"% de horas de uso restantes");
		...
		System.out.println();
		System.out.println("Com base na hora de uso, a Serra tem " + serra.calcDesgaste(serra.gethora_uso())+"% de horas de uso restantes");
